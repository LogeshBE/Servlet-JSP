<%-- 
    Document   : viewallcustomeracc
    Created on : Feb 13, 2020, 5:16:55 AM
    Author     : LAP
--%>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Dealer Account <span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li><a href="viewalldealeracc.jsp">View all D.Accounts</a></li>
        </ul>
      </li>
...
<div class="container">
  ...
  <div class="cols-sm-1"></div>
    <div class="col-sm-8">
        ...
        <form method="get" action="\Grocery_Store\viewallcustomeraccservlet">
            <label for="usr"><h1>Click the below button to view all the customer Accounts in this Branch</h1></label>
